            ...
            <div className="counters">
                {
                    shopCounters.map((counter, index) => {
                        ...
                        return <Counter no={counter.counterNo} queueCount={counter.queue.queueCount} isOpen={counter.queue.isOpen} btn={{ text: "Open", type: "btn", isDisabled: !counter.queue.isOpen, onClickHandler: () => handleRedirect(counter.counterNo) }} key={index} />
                    })
                }
            </div>
        </div>
